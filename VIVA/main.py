...
def Input():
    ...
    if any(keyword in user_input.lower() for keyword in keywords):
    ...
    elif "what is your name?" in user_input.lower() or "fullform of VIVA" in user_input.lower():
        response_str = "My Name is VIVA - Virtually Intelligent Voice Assistant"

    elif "generate an image" in user_input.lower() or "draw an image" in user_input.lower():
        n = 1
        ...
        engine.runAndWait()
        content = Audio()
        response_str = Mailbox(mail, content)
